(define-module (crates-io po st post-archiver) #:use-module (crates-io))

(define-public crate-post-archiver-0.0.0 (c (n "post-archiver") (v "0.0.0") (d (list (d (n "chrono") (r "^0.4.38") (f (quote ("serde"))) (d #t) (k 0)) (d (n "serde") (r "^1.0.203") (f (quote ("derive"))) (d #t) (k 0)) (d (n "ts-rs") (r "^8.1.0") (f (quote ("chrono-impl" "no-serde-warnings"))) (o #t) (d #t) (k 0)))) (h "0mbgjv5p665dmqad0547rir4zljdvl0ldd0g4lfkdljyifwlgc0h") (f (quote (("typescript" "ts-rs")))) (s 2) (e (quote (("ts-rs" "dep:ts-rs"))))))
